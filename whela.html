...
<head>
  ...
  <meta property="og:description" content="Spin the wheel & see what you win!" />
  <meta property="og:url" content="https://your-username.github.io/spinning-wheel/" />
...
<body>
  <div class="wheel-container">
    ...
    <div class="center-box" id="center-box">
      <span class="center-text" id="center-text">B4U</span>
    </div>
  </div>
  ...
  <script>
    ...
    function animateSpin() {
      ...
      if (Math.abs(spinVelocity) < 0.001) {
        ...
        centerText.innerText = 'You Won: ' + (winningIndex + 1) + ' 🎉';
